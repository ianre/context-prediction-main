...
class Iterator:
    ...
    def __init__(self, task):
        ...
        self.context_output = os.path.join(self.CWD,task,"2023_PRES_vis_context_labels_v1")        
        ...
        self.contourDir =  os.path.join(self.CWD,task,"2023_contour_points") # All of the contour points generated by contours.py
        self.OS = "windows" 
    ...
    def CheckDataIntegrity(self):
        ...
        Tissues, TissueFrames = self.getTissueData(TestMode=True,MatchLines=8) # tissue points 
        GrasperJaws, GrasperFrames = self.getGrasperJawData(TestMode=True,MatchLines=4) # grasper points
    ...
    def GenerateContext(self,SAVE=False):
        ...
        sorted(FilenamesInTask,reverse=False)
        for Trial in FilenamesInTask:
            ...
            for root, dirs, files in os.walk(TrialRoot):
                for file in files:
                    ...
                    threadRoot = root.replace("images","2023_PRES_thread_masks")
                    ...
                    threadMaskImage = os.path.join(threadRoot, file)#threadMaskImage = os.path.join(threadRoot, file.replace(".png","_pred.png"))
    ...
    def getTissueData(self,TestMode=False,MatchLines=0):
        ...
        for root, dirs, files in os.walk(self.tissueDir):
            for file in files:
                ...
                T = utils.ViaJSONInterface(tissueFname,TestMode,MatchLines)
    ...
    def getGrasperJawData(self,TestMode=False,MatchLines=0):
        ...
        for root, dirs, files in os.walk(self.grasperJawDir):
            for file in files:
                ...
                J = utils.ViaJSONInterface(jawsFname,TestMode,MatchLines)
