...
class Context_Iterator:
    ...
    def __init__(self, task,CDW):
        ...
        self.context_output = os.path.join(self.CWD,task,"2023_vis_context_labels_v1")        
    ...
    def getTissueData(self,task,TestMode=False,MatchLines=0):
        #print("Starting:getTissueData ->")
        Tissues, TissueFrames = {}, {}
        file = os.path.join(self.tissueDir,task+".json")        
    ...
    def GenerateContext(self, BATCH_SIZE, EPOCH,TRIAL, FRAME_NUMS, SAVE=False):
        count = 0
        ...
        for Trial in FilenamesInTask:
            ...
            for root, dirs, files in os.walk(TrialRoot):
                for file in files:
                    ...
                    threadRoot = root.replace("images","2023_thread_masks")
